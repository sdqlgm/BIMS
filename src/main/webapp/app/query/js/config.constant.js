...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //班级管理
        'queryClassManageController': 'query/js/controllers/assetManagement/classManage/queryClassManageController.js',
        'classManageService': 'query/js/controllers/assetManagement/classManage/classManageService.js',
        
        //学生信息
        'queryStudentManageController': 'query/js/controllers/assetManagement/studentManage/queryStudentManageController.js',
        'updateStudentManageController': 'query/js/controllers/assetManagement/studentManage/updateStudentManageController.js',
        'addStudentManageController': 'query/js/controllers/assetManagement/studentManage/addStudentManageController.js',
        'studentManageService': 'query/js/controllers/assetManagement/studentManage/studentManageService.js',
        
        //基站管理
        'queryBaseStationManageController': 'query/js/controllers/assetManagement/baseStationManage/queryBaseStationManageController.js',
        'updateBaseStationManageController': 'query/js/controllers/assetManagement/baseStationManage/updateBaseStationManageController.js',
        'addBaseStationManageController': 'query/js/controllers/assetManagement/baseStationManage/addBaseStationManageController.js',
        'baseStationManageService': 'query/js/controllers/assetManagement/baseStationManage/baseStationManageService.js',
        
        //读卡器管理
//        'readerManageCtrl': 'query/js/controllers/assetManagement/readerManage/readerManageController.js',
//        'readerManageService': 'query/js/controllers/assetManagement/readerManage/readerManageService.js',
        
        //天线管理
        'queryAntennaManageController':'query/js/controllers/assetManagement/antennaManage/queryAntennaManageController.js',
        'updateAntennaManageController':'query/js/controllers/assetManagement/antennaManage/updateAntennaManageController.js',
        'addAntennaManageController':'query/js/controllers/assetManagement/antennaManage/addAntennaManageController.js',
        'antennaManageService': 'query/js/controllers/assetManagement/antennaManage/antennaManageService.js',
       
        //道路管理
        'queryRoadManageController':'query/js/controllers/assetManagement/roadManage/queryRoadManageController.js',
        'updateRoadManageController':'query/js/controllers/assetManagement/roadManage/updateRoadManageController.js',
        'addRoadManageController':'query/js/controllers/assetManagement/roadManage/addRoadManageController.js',
        'roadManageService': 'query/js/controllers/assetManagement/roadManage/roadManageService.js',
	//系统设置-->基站类型
        'baseStationManageTypeController':'query/js/controllers/systemConfig/baseStationManageTypeController.js',
        'baseStationManageTypeService':'query/js/controllers/systemConfig/baseStationManageTypeService.js',
       
       
        
        //***********************Demo********************************//
        'dashboardCtrl': 'query/js/controllers/dashboardCtrl.js',
        'demoModalCtrl': 'query/js/controllers/demo/demoModalCtrl.js',
        'demoNotificationCtrl': 'query/js/controllers/demo/demoNotificationCtrl.js',
        'dateTimeCtrl': 'query/js/controllers/demo/dateTimeCtrl.js',
        
        
        
        //*** Filters
        'htmlToPlaintext': 'query/js/filters/htmlToPlaintext.js'
    },
