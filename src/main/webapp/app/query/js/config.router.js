...
function ($stateProvider, $urlRouterProvider, $locationProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, $httpProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        url: "/app",
        templateUrl: "query/views/app.html",
...
//***********************资产管理********************************//
    ...
    .state('app.assetManagement.studentManage', {
        ...
        templateUrl: "query/views/assetManagement/studentManage/studentManage.html",
        title: '学生管理',
        ncyBreadcrumb: {
            label: '学生管理'
        },
...
//***********************demo********************************//    
    .state('app.demo', {
        ...
        url: '/modal',
        templateUrl: "query/views/demo/modal.html",
        title: '模态框',
        ncyBreadcrumb: {
            label: '模态框'
        },
        ...
        url: '/Notifications',
        templateUrl: "query/views/demo/notification.html",
        title: '通知',
        ncyBreadcrumb: {
            label: '通知'
        },
        ...
        url: '/dateTime',
        templateUrl: "query/views/demo/dateTime.html",
        title: '时间',
        ncyBreadcrumb: {
            label: '时间'
        },
   ...
   .state('error.404', {
        url: '/404',
        templateUrl: "query/views/utility_404.html",
    }).state('error.500', {
        url: '/500',
        templateUrl: "query/views/utility_500.html",
    })
    ...
    .state('app.pages', {
        ...
        url: '/user',
        templateUrl: "assets/views/demo/user.html",
        title: '模态框',
        ncyBreadcrumb: {
            label: '模态框'
        },
